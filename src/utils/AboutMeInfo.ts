...
export const aboutMeInfo: SignedImageProps[] = [
  ...
  {
    image: Alisa,
    text: 'When I have free time I love spending it with my friends and (as you could guess). But also, I love spending some time with myself, which is extremely important.<br/><br/>I enjoy writing and have a page dedicated to this on my website.<br/><br/>Another hobby of mine is cooking! I love making food or (even more) some unusual drinks and cocktails. And I let my imagination run wild, when I do :)'
  },
  {
    image: Alisa,
    text: 'Some other things I have interest in life include, but not limited to:<br/>• travelling<br/>• jigsaw puzzles<br/>• meditation & yoga<br/>• rock climbing<br/>• soldering'
  }
]