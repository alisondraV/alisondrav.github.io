...
export const aboutMeInfo: SignedImageProps[] = [
  ...
  {
    image: Interests,
    text: 'Some other things I have interest in life include, but not limited to:<br/>• travelling<br/>• jigsaw puzzles<br/>• meditation & yoga<br/>• rock climbing<br/>• soldering<br/>• attending various art galleries and exhibitions'
  }
]